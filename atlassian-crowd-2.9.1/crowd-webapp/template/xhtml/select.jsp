...
<select name="<webwork:property value="parameters['name']"/>"
        ...
        class="select<webwork:if test="parameters['cssClass'] != null"> <webwork:property value="parameters['cssClass']"/></webwork:if><webwork:if test="parameters['fieldWidth'] != null"> <webwork:property value="parameters['fieldWidth']"/>-field</webwork:if>"
