...
<textarea name="<webwork:property value="parameters['name']"/>"
        ...
        class="textarea<webwork:if test="parameters['cssClass'] != null"> <webwork:property value="parameters['cssClass']"/></webwork:if><webwork:if test="parameters['fieldWidth'] != null"> <webwork:property value="parameters['fieldWidth']"/>-field</webwork:if>"
