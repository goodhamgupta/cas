...
<div class="aui-tabs horizontal-tabs aui-tabs-disabled">
    ...
    <div class="tabs-pane active-pane">
        ...
        <ww:component template="form.jsp" id="permissions">
            <ww:param name="action"><ww:url namespace="/console/secure/directory" action="updatecustompermissions" method="update" includeParams="none" /></ww:param>
            <ww:param name="content" value="#formContent" />
            <ww:param name="cancelUri"><ww:url namespace="/console/secure/directory" action="viewcustom" method="default" includeParams="none"><ww:param name="ID" value="ID" /></ww:url></ww:param>
        </ww:component>
    </div>
</div>
