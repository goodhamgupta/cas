...
<head>
    ...
    <script>
        function testPrincipalSearch() {
            ...
            form.action = "<ww:url namespace="/console/secure/directory" action="updatedelegatedconfiguration" method="testUpdatePrincipalSearch" includeParams="none"/>";
            form.submit();
        }

        function testGroupSearch() {
            var form = document.getElementById('configuration_details');
            form.action = "<ww:url namespace="/console/secure/directory" action="updatedelegatedconfiguration" method="testUpdateGroupSearch" includeParams="none"/>";
            form.submit();
        }
    </script>
</head>
...
<div class="aui-tabs horizontal-tabs aui-tabs-disabled">
    ...
    <div class="tabs-pane active-pane">
        ...
        <ww:component template="form.jsp" id="configuration_details">
            <ww:param name="action"><ww:url namespace="/console/secure/directory" action="updatedelegatedconfiguration" method="update" includeParams="none" /></ww:param>
