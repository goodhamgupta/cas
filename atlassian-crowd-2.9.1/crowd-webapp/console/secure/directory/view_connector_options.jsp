...
<head>
    ...
    <meta name="help.url" content="<ww:text name="help.directory.connector.options"/>"/>
    ...
    <script>
        AJS.$(function(){
            CROWD_PICKER.attachPicker("addGroups", "<ww:property value="getText('picker.addgroups.label')"/>",
                    ...
                    "<ww:url namespace="/console/secure/directory" action="updateconnectoroptions" method="addDefaultGroups" includeParams="none" escapeAmp="false"><ww:param name="ID" value="ID"/></ww:url>",
                    ...
                    "<ww:url namespace="/console/secure/directory" action="updateconnectoroptions" includeParams="none" escapeAmp="false"><ww:param name="ID" value="ID"/></ww:url>");
        });
    </script>
</head>
<body>
...
<div class="aui-tabs horizontal-tabs aui-tabs-disabled">
    ...
    <div class="tabs-pane active-pane">
            ...
            <ww:else>
                ...
                <ul>
                    <ww:iterator value="defaultGroups">
                        <li>
                            <ww:property/>
                            <a href="<ww:url namespace="/console/secure/directory" action="updateconnectoroptions" method="removeDefaultGroup"><ww:param name="ID" value="ID"/><ww:param name="groupToRemove" value="top"/><ww:param name="%{xsrfTokenName}" value="%{xsrfToken}"/></ww:url>">
        ...
        <ww:component template="form.jsp" id="updateGeneral">
            <ww:param name="action"><ww:url namespace="/console/secure/directory" action="updateconnector" includeParams="none" /></ww:param>
