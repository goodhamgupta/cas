...
<head>
    ...
    <meta name="help.url" content="<ww:property value="getText('help.directory.delegated.permissions')"/>"/>
</head>
<body>
<h2>
    <ww:text name="menu.viewdirectory.label">
...
<div class="aui-tabs horizontal-tabs aui-tabs-disabled">
    ...
    <div class="tabs-pane active-pane">
        ...
        <ww:component template="form.jsp" id="permissions">
            <ww:param name="action"><ww:url namespace="/console/secure/directory" action="updatedelegatedpermissions" method="update" includeParams="none" /></ww:param>
