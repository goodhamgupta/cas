...
<html>
<head>
    <title><ww:property value="getText('principal.remove.title')"/></title>
...
<h2><ww:property value="getText('principal.remove.title')"/>&nbsp;&ndash;&nbsp;<ww:property value="name"/></h2>
...
<ww:component template="form.jsp" id="remove-user-form">
    <ww:param name="action"><ww:url namespace="/console/secure/user" action="remove" method="update" includeParams="none" /></ww:param>
    ...
    <ww:param name="includeSubmitButton" value="!currentUser" />
</ww:component>
