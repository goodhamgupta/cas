...
public class ViewUser extends BaseAction
{
    ...
    protected void processGeneral()
            throws InvalidAuthorizationTokenException, RemoteException, ApplicationPermissionException, UserNotFoundException, InvalidAuthenticationException, OperationFailedException
    {
    ...
    protected void processMemberships()
            throws InvalidAuthorizationTokenException, RemoteException, ApplicationPermissionException, InvalidAuthenticationException, OperationFailedException
    {
        // find all the groups
