...
<%@ page import="com.atlassian.crowd.util.build.BuildUtils" %>
...
<head>
    ...
    <%
        ...
        if (exception != null)
        {
            ...
            LoggerFactory.getLogger("500ErrorPage").error("Exception caught in 500 page " + cause.getMessage(), cause);
...
<ww:i18n name="com.atlassian.crowd.console.action.BaseAction" >
    ...
    <p>
        ...
        : <%= StringEscapeUtils.escapeHtml4(BuildUtils.getVersion()) %>
    </p>
